        ...
        <DocPageWrapper>
            <div>
                ...
                <DocParagraph className="mt-4 max-w-lg">
                    Integrate Xevos directly over HTTP. No SDK required — works in any language or
                    runtime.
                </DocParagraph>
            </div>
...
XEVOS_API_KEY=px_live_xxxxxxxxx`}
                ...
                <DocParagraph className="mt-4">
                    All endpoints are versioned under <InlineCode>/v1</InlineCode>. Authenticate
                    every request by passing your API key in the{" "}
  ...
  -H "Authorization: Bearer px_live_xxxxxxxxx"`}
                ...
                <Callout type="note" className="mt-4">
                    Keep your API key out of client-side code. All requests should originate from
                    your server.
                </Callout>
            </DocSection>
  ...
  "deployed_at": "2025-06-01T10:22:00Z"
            ...
            <DocSection id="session" label="Experiments" title="A/B Testing">
                <DocParagraph>
                    Pass a stable <InlineCode>session_id</InlineCode> to enable consistent variant
                    assignment across traffic splits.
                </DocParagraph>
