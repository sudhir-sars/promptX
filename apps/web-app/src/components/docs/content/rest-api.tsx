...
export default function RestApiContent() {
	return (
		<DocPageWrapper>
			<div>
				<h1 className="text-[22px] font-semibold tracking-tight text-foreground/90 md:text-[26px]">REST API</h1>
...
XEVOS_API_KEY=px_live_xxxxxxxxx`}
				...
				<DocParagraph className="mt-4">
					All endpoints are versioned under <InlineCode>/v1</InlineCode>. Authenticate every request by passing your API
					key in the <InlineCode>Authorization</InlineCode> header.
				</DocParagraph>
			</DocSection>
  ...
  "deployed_at": "2025-06-01T10:22:00Z"
			...
			<DocSection id="session" label="Experiments" title="A/B Testing">
				<DocParagraph>
					Pass a stable <InlineCode>session_id</InlineCode> to enable consistent variant assignment across traffic
					splits.
				</DocParagraph>
  ...
  -H "Authorization: Bearer px_live_xxxxxxxxx"`}
			...
			<DocSection id="llm-usage" label="LLMs" title="Use with an LLM">
				<DocParagraph>Fetch the prompt and pass its content to your model in the same request cycle.</DocParagraph>
