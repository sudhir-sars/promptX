    ...
    <DocPageWrapper>
      <section className="border-b border-border/50 pb-10">
        ...
        <DocParagraph className="mt-5 max-w-3xl text-balance">
          PromptX is the first product in the Xevos AI ecosystem. Our vision extends beyond prompt
          management. We are building a complete platform for creating, deploying, operating,
          scaling, and monetizing AI agents from a single unified environment.
        </DocParagraph>

        <div className="mt-8 flex flex-wrap gap-2">
          {["Agent Development", "Deployments", "Hosting", "Marketplace", "Monetization"].map(
            (tag) => (
              <div
                key={tag}
      ...
      <DocSection id="vision" label="Long Term Vision" title="The future of Xevos AI">
        <DocParagraph>
          Xevos AI aims to become the platform where developers build, deploy, operate, distribute,
          and monetize AI agents. From prompt creation to production infrastructure, every part of
          the agent lifecycle should be managed from one place.
        </DocParagraph>

        <Callout type="note" className="mt-4">
          Roadmaps represent our current direction and priorities. Features and timelines may evolve
          as we continue learning from developers and teams.
        </Callout>
      </DocSection>
      ...
      <DocSection id="knowledge" label="Data Layer" title="Managed Knowledge Infrastructure">
        <DocParagraph>
          Every serious AI agent requires access to business data. Xevos AI will provide managed
          knowledge services that allow developers to create custom knowledge bases without managing
          infrastructure.
        </DocParagraph>
