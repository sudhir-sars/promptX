    ...
    return (
        <DocPageWrapper>
            ...
            <DocSection id="api-key" label="Credentials" title="API key">
                <DocParagraph>
                    Your API key is used to authenticate requests made through the PromptX SDK. You
                    can view or regenerate your key from the dashboard at any time.
                </DocParagraph>

                <Callout type="warning" className="mt-4">
                    Keep your API key secret. Anyone with access to the key can make requests on
                    behalf of your PromptX account.
                </Callout>
            </DocSection>
            ...
            <DocSection id="setup" label="Setup" title="Adding your API key">
                <DocParagraph>
                    Store your API key in an environment variable and load it when creating a
                    PromptX client.
                </DocParagraph>
...
const promptx = new PromptX({
  apiKey: process.env.PROMPTX_API_KEY!,
            ...
            <DocSection id="rotation" label="Security" title="Regenerating your API key">
                <DocParagraph>
                    If your API key is compromised or needs to be rotated, generate a new key from
                    the dashboard and update any applications using the old key.
                </DocParagraph>
            </DocSection>
