    ...
    <DocPageWrapper>
      <div>
        ...
        <DocParagraph className="mt-4 max-w-lg">
          Use PromptX from Route Handlers, Server Actions, Edge Runtime, and other server-side code.
          Prompts are typically resolved immediately before making a model request.
        </DocParagraph>
      </div>
      ...
      <DocSection id="installation" label="Setup" title="Installation">
        ...
        <DocParagraph className="mt-4">
          PromptX works with both App Router and Pages Router. No Next.js-specific package is
          required.
        </DocParagraph>
      </DocSection>
      ...
      <DocSection id="configuration" label="Configuration" title="Configuration">
        <DocParagraph>
          The SDK automatically reads <InlineCode>PROMPTX_API_KEY</InlineCode>. In most cases,
          that's all you need.
        </DocParagraph>
  ...
  return NextResponse.json({
    reply: completion.choices[0].message.content,
        ...
        <Callout type="tip" className="mt-4">
          Pass a stable identifier such as the current chat ID when using A/B testing or traffic
          allocation.
        </Callout>
      </DocSection>
