        ...
        <DocPageWrapper>
            <section className="border-b border-border/50 pb-10">
                ...
                <DocParagraph className="mt-5 max-w-2xl text-balance">
                    Follow the evolution of PromptX. Every release includes new features, platform
                    improvements, bug fixes, and deployment updates.
                </DocParagraph>
            ...
            <DocSection id="v0-1-0" label="May 2026" title="v0.1.0 — Initial Public Release">
                <DocParagraph>
                    The first public release of PromptX introduces the core platform for managing
                    prompts as production infrastructure.
                </DocParagraph>
                ...
                <div className="mt-8 space-y-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-muted-foreground">
                            ...
                            <li>
                                • Standardized API key format using{" "}
                                <InlineCode>px_live_</InlineCode>
                            </li>
            ...
            <DocSection id="upcoming" label="Next Release" title="What's coming next">
                <DocParagraph>
                    We are actively working on new SDKs, deployment workflows, and collaboration
                    features.
                </DocParagraph>
