		...
		>
			...
			<div className="relative z-10 mx-auto max-w-3xl px-8 pb-24 pt-20 md:px-16 lg:px-8">
				...
				<div className="mb-5 flex items-center gap-3">
					...
					<p className="text-[10px] font-medium uppercase tracking-[0.18em] text-muted-foreground">Legal</p>
				</div>
				...
				<p className="mt-3 text-[10px] uppercase tracking-[0.15em] text-foreground/25">Last updated — {lastUpdated}</p>
	...
	return (
		<section id={id} className="scroll-mt-24">
			<div className="mb-3 flex items-center gap-3">
				...
				<h2 className="text-[15px] font-semibold tracking-tight text-foreground/85">{title}</h2>
			</div>
			<div className="pl-10 text-[13px] leading-[1.8] text-muted-foreground [&>p+p]:mt-3">{children}</div>
		</section>
	);
}
