		...
		<footer className="px-8 pb-10 pt-6 md:px-16 lg:px-24">
			<div className="mx-auto max-w-5xl">
				...
				<div className="flex flex-col justify-between gap-10 pt-10 md:flex-row">
					{/* Brand */}
					<div>
						<Link href="/" className=" text-[12px] font-semibold uppercase tracking-[0.15em] text-foreground">
							XEVOS AI
						</Link>
						<p className="mt-2 text-[12px] text-muted-foreground">Production-grade prompt management.</p>
					</div>
