const features = [
	...
	{
		title: "Teams",
		description: "Collaborate across shared workspaces with roles, permissions, and activity history.",
	},
	{
		title: "Evaluations",
		description: "Measure prompt quality with automated testing, scoring, and performance analysis.",
	},
	{
		title: "Metrics",
	...
	return (
		<section className="px-8 py-20 md:px-16 md:py-28 lg:px-24">
			<div className="mx-auto max-w-5xl">
				<p className="mb-6  text-[10px] uppercase tracking-[0.15em] text-foreground/70">What you get</p>
				...
				<div className="grid grid-cols-1 gap-px overflow-hidden rounded-[32px] border border-foreground/[0.08] sm:grid-cols-2 lg:grid-cols-3">
					{features.map((feature) => (
						...
						>
							<p className=" text-[11px] uppercase tracking-[0.12em] text-foreground/70">{feature.title}</p>
