const features = [
...

    {
        ...
        description:
            "Immutable version history with complete traceability for every prompt change.",
    },
    {
        title: "Deployments",
    ...
    },
    {
        title: "Metrics",
        description:
            "Bring your own success metrics and monitor them alongside prompt performance.",
    },
    {
        title: "Intelligence",
        description:
            "Surface actionable insights from production usage, outcomes, and user behavior.",
    },
];
