...
import { ChevronLeftIcon, DeployIcon, ObservabilityIcon, SettingsIcon, StudioIcon, VersionsIcon } from "../ui/icons";
							...
							<div className="mt-6 xl:hidden">
								...
								<div className="flex gap-3 overflow-x-auto pb-2 no-scrollbar">
									{versions.map((item, index) => (
										<div key={item.label} className="min-w-[170px] rounded-2xl border border-foreground/[0.08] p-4">
											<p
												className={`text-xs ${
