...
import { TeamIcon, PromptIcon } from "@/components/ui/icons";
...
const EMPTY_STATE_CONFIG: Record<EmptyStateVariant, EmptyStateConfig> = {
    team: {
        title: "No teams yet",
        description:
            "Create your first team workspace to collaborate, organize prompts, and manage projects.",
        icon: TeamIcon,
    },
        ...
        <div className="flex h-full w-full items-center justify-center px-6">
            <div className="flex max-w-sm flex-col items-center text-center">
                ...
                {showAction && (
                    <Button
                        variant="outline"
                        className="mt-6 rounded-full px-10 text-xs"
                        onClick={action}
                    >
