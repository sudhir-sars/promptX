	...
	return (
		<div className="h-full flex-1 space-y-7  overflow-y-auto no-scrollbar px-6 py-20 md:px-10 lg:px-16 transition-all duration-300 ease-in-out">
			...
			<section className="overflow-hidden rounded-3xl border">
				<div className="flex flex-col items-center px-8 py-16 text-center">
					...
					<p className="mt-4 max-w-2xl text-sm leading-6 text-muted-foreground">
						Insights will help you understand how this prompt performs in production. Monitor adoption, latency,
						quality, deployments, and operational health from a single place.
					</p>
			...
			<div className="grid gap-4 md:grid-cols-3">
				<FeatureCard title="Usage" description="Requests, token consumption, and adoption trends." />

				<FeatureCard title="Performance" description="Latency distributions, throughput, and response times." />

				<FeatureCard title="Quality" description="Prompt evaluations, regressions, and version comparisons." />
			</div>
		</div>
	);
}
