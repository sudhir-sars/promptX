	...
	return (
		<div className="h-full flex-1 space-y-7 overflow-y-auto no-scrollbar px-6 py-20 md:px-10 lg:px-16 transition-all duration-300 ease-in-out">
			...
			<section className="overflow-hidden rounded-4xl border">
				<div className="flex flex-col items-center px-8 py-16 text-center">
					...
					<p className="mt-4 max-w-2xl text-sm leading-6 text-muted-foreground">
						Follow deployments, prompt updates, rollbacks, member actions, and workspace events through a unified
						activity timeline.
					</p>
			...
			<div className="grid gap-4 md:grid-cols-3">
				<FeatureCard title="Deployments" description="Track releases, traffic changes, and deployment history." />

				<FeatureCard title="Version History" description="Monitor prompt updates and publishing activity." />

				<FeatureCard title="Team Activity" description="View member actions, invitations, and access changes." />
			</div>
		</div>
	);
}
