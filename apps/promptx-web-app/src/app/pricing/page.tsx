        ...
        >
            ...
            <div className="relative z-10 mx-auto max-w-5xl px-8 pb-24 pt-20 md:px-16 lg:px-8">
                ...
                <p className="mt-5 max-w-md text-[13px] leading-relaxed text-muted-foreground">
                    Free for individuals. Scaled pricing for teams. No hidden fees, no surprise
                    overages.
                </p>
                    ...
                    {tiers.map((tier) => (
                        ...
                        >
                            ...
                            <div className="mt-4 flex items-baseline gap-1.5">
                                <span className="text-[32px] font-bold tracking-tight text-foreground/90">
                                    {tier.price}
                                </span>
                                {tier.period && (
                            ...
                            >
                                <Link href={tier.name === "Enterprise" ? "/contact" : "/sign-in"}>
                                    {tier.cta}
                                </Link>
                            </Button>
                        </div>
                ...
                <div className="mt-20">
                    ...
                    <div className="flex flex-col gap-px overflow-hidden rounded-[24px] border border-foreground/[0.06]">
                        {faq.map((item) => (
                            <div
                                key={item.q}
                                className="border-b border-foreground/[0.04] p-6 last:border-b-0"
                            >
